...
contract ExchangeCore is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function atomicMatch(
        ...
        if (buy.maker == msg.sender) {
            ...
            require(validateOrderParameters(buy), "Validate buy return false");
        } else {
        ...
        if (sell.maker == msg.sender) {
            ...
            require(validateOrderParameters(sell), "Validate sell return false");
        } else {
        ...
        require(ordersCanMatch(buy, sell), "Orders can not match");
        ...
        require(ArrayUtils.arrayEq(buy._calldata, sell._calldata), "Calldata array not equal");
        ...
        if (buy.staticTarget != address(0)) {
            require(staticCall(buy.staticTarget, sell._calldata, buy.staticExtradata), "Static call return false");
        }

        /* Handle sell-side static call if specified. */
        if (sell.staticTarget != address(0)) {
            require(staticCall(sell.staticTarget, sell._calldata, sell.staticExtradata), "Static call return false");
        }
